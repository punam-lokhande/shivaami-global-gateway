...
const CaseStudyShauryaTechnosoft = () => {
  const highlights = [
    "Full Google Workspace deployment for software teams",
    "Secure email infrastructure with advanced controls",
    "Real-time collaboration tools for developers",
    "Google Meet for seamless video conferencing",
    "Centralized project documentation on Drive",
    "Admin console for IT governance and security"
  ];

  const challenges = [
    "Distributed development teams needed unified platform",
    "Legacy email system lacked modern security features",
    "Project documentation scattered across multiple systems"
  ];

  const solutions = [
    "Implemented Google Workspace for unified collaboration",
    "Configured security policies and 2-step verification",
    "Migrated all project docs to organized Drive structure"
  ];

  const results = [
    { label: "Dev Collaboration", value: "Enhanced" },
    { label: "Email Security", value: "99.9%" },
    { label: "Meeting Efficiency", value: "Improved" },
    { label: "Doc Management", value: "Centralized" }
  ];
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Shaurya Technosoft Upgraded to<br />
              <span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A growing technology company streamlined their development workflows with Google Workspace for enhanced team productivity.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 border-b border-gray-200">
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              { label: "Industry", value: "Technology & IT" },
              { label: "Solution", value: "Google Workspace" },
              { label: "Focus", value: "Dev Teams" },
              { label: "Result", value: "Unified Platform" }
            ].map((item, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Modern collaboration for software development</p>
              </div>
            </motion.div>
          </div>
        </div>
