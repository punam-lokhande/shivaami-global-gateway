...
const CaseStudyEmxcel = () => {
  const highlights = [
    "Complete Google Workspace migration for IT solutions team",
    "Enterprise-grade email security and compliance",
    "Cloud-based collaboration for client projects",
    "Google Drive for secure file management",
    "Admin controls for data governance",
    "User training for seamless adoption"
  ];

  const challenges = [
    "Growing client base required scalable infrastructure",
    "Need for enterprise-level security for client data",
    "Collaboration gaps between onsite and remote teams"
  ];

  const solutions = [
    "Deployed Google Workspace Business Plus for enhanced features",
    "Implemented DLP policies and advanced security controls",
    "Configured shared drives for organized project management"
  ];

  const results = [
    { label: "Client Satisfaction", value: "Increased" },
    { label: "Data Security", value: "Enterprise" },
    { label: "Team Efficiency", value: "40% Up" },
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Emxcel Solutions Powered by<br />
              <span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A technology and IT solutions provider enhanced their service delivery capabilities with Google Workspace enterprise collaboration.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Focus", value: "Client Services" },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Secure collaboration for IT excellence</p>
              </div>
            </motion.div>
          </div>
        </div>
