...
const CaseStudyPrism = () => {
  const highlights = [
    "Google Workspace deployment for healthcare operations",
    "Secure email with patient data compliance",
    "Cloud-based collaboration for medical teams",
    "Google Drive for secure clinical documentation",
    "Mobile device management for healthcare staff",
    "Admin controls for regulatory compliance"
  ];

  const challenges = [
    "Strict healthcare data privacy requirements",
    "Need for seamless communication across departments",
    "Legacy systems lacking modern security features"
  ];

  const solutions = [
    "Deployed Google Workspace with healthcare-grade security",
    "Configured DLP policies for patient data protection",
    "Implemented comprehensive staff training programs"
  ];

  const results = [
    { label: "Staff Connected", value: "100%" },
    { label: "Data Security", value: "Enhanced" },
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/prism" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Prism Healthcare Transformed with<br />
              <span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A healthcare organization enhanced their clinical collaboration and patient data management with secure Google Workspace deployment.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Focus", value: "Clinical Ops" },
              { label: "Security", value: "Healthcare-grade" }
            ].map((item, index) => (
              <motion.div
                key={index}
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-4 left-4 right-4"><p className="text-white font-medium text-sm">Secure collaboration for healthcare</p></div>
            </motion.div>
          </div>
        </div>
      </section>
