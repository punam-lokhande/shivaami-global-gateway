...
import { 
  ...
  MessageSquare, FileCheck, Database, Cpu, Clock, Network, Eye, Cloud
} from 'lucide-react';
  ...
  return (
    <section ref={ref} className="relative h-[70vh] min-h-[500px] max-h-[600px] flex items-center overflow-hidden">
      ...
      >
        <img
          src={technologyImage}
          alt="Software & Technology IT Solutions"
      ...
      <motion.div style={{ opacity }} className="relative z-10 w-full px-8 lg:px-16 xl:px-24 pt-24 lg:pt-28">
        <div className="max-w-3xl">
          ...
          >
            <Cpu className="w-4 h-4 text-[#38B6FF]" />
            <span className="text-white/90 text-sm font-medium">Software & Technology</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-[#38B6FF]">for High-Growth Tech Teams.</span>
          </motion.h1>
...
// Supporting Agile, Distributed Teams Section
function TechnologySection() {
  const features = [
    {
      icon: Lock,
      title: 'Secure Access',
      desc: 'Secure access for developers and remote teams with identity verification.',
    },
    {
      icon: Users,
      title: 'Identity Management',
      desc: 'Centralized identity and device management across all team members.',
    },
    {
      icon: Shield,
      title: 'Code Protection',
      desc: 'Protection of code, internal systems, and customer data from threats.',
    },
    {
      icon: Cloud,
      title: 'Scalable Infrastructure',
      desc: 'Scalable cloud infrastructure with built-in resilience and redundancy.',
    },
  ];
      ...
      <div className="w-full px-8 lg:px-16 xl:px-24">
        <motion.div {...fadeInUp} className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0C4594] mb-4">
            Supporting Agile, Distributed Teams
          </h2>
          <p className="text-[#475569] max-w-3xl mx-auto">
            Scalable, secure IT infrastructure for technology-driven businesses. Enable collaboration, identity management, and data protection.
          </p>
        </motion.div>
...
// Built for Innovation at Scale Section
function TrustSection() {
  const benefits = [
    {
      icon: Shield,
      title: 'Strong Security',
      desc: 'Strong security without slowing innovation or development velocity.',
    },
    {
      icon: Network,
      title: 'Reduced Risk',
      desc: 'Reduced operational risk across distributed teams and remote workers.',
    },
    {
      icon: Eye,
      title: 'Visibility & Control',
      desc: 'Improved visibility into access and usage across the organization.',
    },
    {
      icon: Clock,
      title: 'Business Continuity',
      desc: 'Business continuity for critical systems ensuring uptime and availability.',
    },
  ];
    ...
    <section className="py-20 bg-white">
      <div className="w-full px-8 lg:px-16 xl:px-24">
        <motion.div {...fadeInUp} className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0C4594] mb-4">
            Built for Innovation at Scale
          </h2>
          <p className="text-[#475569] max-w-3xl mx-auto">
            Our solutions enable technology teams to move fast while maintaining enterprise-grade security.
          </p>
        </motion.div>
