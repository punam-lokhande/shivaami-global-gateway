    ...
    <div className="w-full px-8 lg:px-16 xl:px-24">
      <motion.div {...fadeInUp} className="text-center max-w-4xl mx-auto">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
          Transform IT Operations with SuperOps
        </h2>
        <p className="text-white/90 text-lg mb-8">
          Schedule a consultation with our IT operations specialists
        </p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-10 text-left max-w-3xl mx-auto">
          {[
            "Current IT operations assessment",
            "Tool consolidation opportunities",
            "SuperOps configuration design",
            "Integration and migration planning",
            "Automation and workflow optimization",
            "ROI analysis for unified platform"
          ].map((item, index) => (
