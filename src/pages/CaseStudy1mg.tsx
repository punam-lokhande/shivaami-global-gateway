...
const CaseStudy1mg = () => {
  const highlights = [
    "Google Workspace Enterprise deployment for entire organization",
    "Advanced DLP policies for healthcare data protection",
    "2FA implementation across all user accounts",
    "Cross-team collaboration for pharmacy and telehealth",
    "Google Vault configured for healthcare compliance",
    "Mobile-first solutions for field teams"
  ];

  const challenges = [
    "Rapid growth requiring scalable collaboration infrastructure",
    "Need for secure handling of sensitive healthcare data",
    "Complex operations spanning pharmacy, diagnostics, and teleconsultation"
  ];

  const solutions = [
    "Enterprise-grade Workspace with advanced security features",
    "DLP policies and encryption protecting sensitive data",
    "Seamless coordination between all business verticals"
  ];

  const results = [
    { label: "Users Served", value: "20M+" },
    { label: "System Uptime", value: "99.9%" },
    { label: "Faster Collaboration", value: "60%" },
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/1mg" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              1mg<br />
              <span className="text-[#38B6FF]">Powering Digital Healthcare</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              India's leading health-tech platform providing digital healthcare services with cloud-powered operations serving 20M+ users.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <img 
                ...
                alt="1mg Healthcare Platform" 
                className="w-full h-64 lg:h-80 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0C4594]/60 to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Enterprise healthcare infrastructure</p>
              </div>
            </motion.div>
          </div>
        </div>
