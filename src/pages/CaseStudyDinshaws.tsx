...
const CaseStudyDinshaws = () => {
  const highlights = [
    "460 users migrated from Rediff email service",
  ...
  const challenges = [
    ...
    "IT team struggling with local host email service issues",
  ...
  const results = [
    { label: "Users Migrated", value: "460" },
    { label: "Migration Time", value: "15-20 Days" },
    { label: "Support Reduction", value: "80%" },
    { label: "Google SLA", value: "99.9%" }
  ];
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-3xl">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Dinshaw's Moved to<br /><span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A beloved ice cream brand since 1932, known for consistency and innovative flavors, modernized their collaboration with Google Workspace.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Modern collaboration for retail success</p>
              </div>
            </motion.div>
          </div>
        </div>
...
export default CaseStudyDinshaws;
