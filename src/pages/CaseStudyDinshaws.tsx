...
const CaseStudyDinshaws = () => {
  ...
  const challenges = [
    "Prior to migration, the client was using Rediff email service",
  ...
  const solutions = [
    "With Shivaami's recommendation and support, Dinshaw's switched to Google Workspace Basic Plan on January 07, 2021",
  ...
  const results = [
    "Migration completed in 15-20 days",
    "Spam kept to minimum with filters",
    "IT team devotes more time to business",
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl">
            ...
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed max-w-3xl">
              Dinshaw's was established in 1932 by Dinshaw and Erachshaw Rana. From a dairy operation in Nagpur, their fascination with ice cream led to creating a beloved brand with locations all over India, known for consistency and innovative flavors.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 border-b border-gray-200">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              { label: "Industry", value: "Ice Cream Distributor" },
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
              ...
              <p className="text-white/80 text-lg max-w-3xl mx-auto">Dinshaw's successfully completed data migration in 15-20 days with stakeholders and employees highly satisfied.</p>
            </motion.div>
