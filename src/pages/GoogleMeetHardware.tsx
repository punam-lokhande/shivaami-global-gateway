...
function CalendarCTASection() {
  const demoPoints = [
    'Meeting room assessment and hardware recommendations',
    'Video and audio quality optimization for your spaces',
    'Google Calendar integration and room booking setup',
    'Centralized management and ongoing support options',
  ];
    ...
    <section className="py-20 bg-gradient-to-br from-[#0C4594] via-[#0a3a7a] to-[#082d61]">
      <div className="w-full px-8 lg:px-16 xl:px-24">
        <motion.div {...fadeInUp} className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg text-white/80 mb-8">Upgrade meeting rooms with Google Meet hardware. Schedule a consultation with our video conferencing specialists:</p>
