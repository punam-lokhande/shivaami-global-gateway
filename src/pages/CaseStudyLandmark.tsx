...
const CaseStudyLandmark = () => {
  const highlights = [
    "2,260 users migrated from Rediff to Google Workspace",
    "Email data migration completed via DMS tool",
    "Mail routing configuration for seamless transition",
    "Device management setup for mobile access",
    "Google Workspace security checklist implemented",
    "File storage and sharing via Google Drive"
  ];

  const challenges = [
    "Legacy Rediff email service with limited capabilities",
    "IT team struggling with local host email issues",
    "No MDM, Drive, or compliance settings available"
  ];

  const solutions = [
    "Switched to Google Workspace Basic Plan with Shivaami's support",
    "Comprehensive migration process with planning meetings",
    "User accounts provisioned and data migrated using various methods"
  ];

  const results = [
    { label: "Users Migrated", value: "2,260" },
    { label: "Migration Time", value: "15 Days" },
    { label: "Go-Live Time", value: "3 Days" },
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/landmark" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Landmark Group Migrated<br />
              <span className="text-[#38B6FF]">2,260 Users to Google Workspace</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              One of India's largest luxury and premium car dealerships transformed from legacy Rediff email to modern Google Workspace collaboration.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Previous Setup", value: "Rediff" },
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-4 left-4 right-4"><p className="text-white font-medium text-sm">Enterprise-grade collaboration & security</p></div>
            </motion.div>
          </div>
        </div>
      </section>
