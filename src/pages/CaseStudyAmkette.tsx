...
const CaseStudyAmkette = () => {
  const highlights = [
    "Google Workspace deployment for electronics manufacturing",
    "Unified email and calendar across departments",
    "Shared Drive structure for product development",
    "Mobile device management for field teams",
    "Integration with supply chain systems",
    "Enhanced security policies for IP protection"
  ];

  const challenges = [
    "Multiple communication tools creating data silos",
    "Need for secure collaboration on product designs",
    "Distributed teams across manufacturing and sales locations"
  ];

  const solutions = [
    "Centralized Workspace deployment with unified domains",
    "Secure Shared Drives with access controls for R&D",
    "Mobile-first approach for sales and field teams"
  ];

  const results = [
    { label: "Users Enabled", value: "200+" },
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/amkette" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Amkette Transformed with<br />
              <span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A leading consumer electronics manufacturer streamlined their product development and sales collaboration with modern cloud tools.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Previous Setup", value: "Mixed Tools" },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Electronics manufacturing collaboration</p>
              </div>
            </motion.div>
          </div>
        </div>
...
export default CaseStudyAmkette;
