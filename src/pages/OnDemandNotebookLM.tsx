...
import heroBanner from "@/assets/banners/notebooklm-webinar.jpg";
import WatchOnDemandForm from "@/components/WatchOnDemandForm";

const OnDemandNotebookLM = () => {
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/on-demand-notebooklm" />
      </Helmet>
      <Header />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="overview" className="mt-6">
                  <div className="space-y-4 text-gray-700">
                    ...
                    <p>
                      This module focuses on how to integrate <strong className="text-[#0C4594]">NotebookLM</strong> into daily workflows to streamline tasks, do research, manage projects, and solve complex problems.
                    </p>
                    
                    <p>
                      This session will give users an understanding of what features are available in NotebookLM and how to best leverage it to help users collaborate and be more productive.
                    </p>
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3">
                        ...
                        <div>
                          Learn to use NotebookLM as your AI-powered research assistant
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-[#38B6FF] rounded-full mt-2 flex-shrink-0" />
                        <div>
                          Discover how to analyze and synthesize information from multiple sources
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-[#38B6FF] rounded-full mt-2 flex-shrink-0" />
                        <div>
                          Streamline project management and collaborative workflows
                        </div>
                      </li>
                    </ul>
            ...
            >
              <WatchOnDemandForm 
                ...
                moduleName="NotebookLM"
                youtubeUrl="https://www.youtube.com/watch?v=eb5-ba_0PyA"
              />
              ...
              <div className="mt-6 bg-gradient-to-r from-[#38B6FF]/10 to-[#0C4594]/10 rounded-xl p-4 border border-[#38B6FF]/30">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="text-[#0C4594] font-medium">✓ Module 4: NotebookLM (You are here)</div>
...
export default OnDemandNotebookLM;
