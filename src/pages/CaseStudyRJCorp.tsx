...
const CaseStudyRJCorp = () => {
  const highlights = [
    "Google Workspace Frontline for 4,400 users",
    "DMS migration for seamless email transfer",
    "Mail routing configuration completed",
    "Device management for secure mobile access",
    "Security checklist implementation",
    "File storage enabled with Google Drive"
  ];

  const challenges = [
    "Zimbra email service was difficult to manage locally",
    "No MDM, Drive, or compliance settings available",
    "Need for minimum server downtime during migration"
  ];

  const solutions = [
    "Google Workspace Frontline Plan for all 4,400 users",
    "DMS migration for seamless email data transfer",
    "Comprehensive security checklist implementation"
  ];

  const results = [
    { label: "Customer Live", value: "3 Days" },
    { label: "Full Migration", value: "15 Days" },
    { label: "Users Migrated", value: "4,400" },
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              RJ Corp Migrated from<br />
              <span className="text-[#38B6FF]">Zimbra to Google Workspace</span>
            </h1>
      ...
      <section className="bg-gray-50 border-b border-gray-200">
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              { label: "Industry", value: "Consumer Products" },
              { label: "Old Service", value: "Zimbra" },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <img 
                ...
                alt="Google Workspace Enterprise Migration" 
                className="w-full h-64 lg:h-80 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0C4594]/60 to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Enterprise-scale migration for 4,400 users</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16">
        <div className="w-full px-8 lg:px-16 xl:px-24">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-[#0C4594] mb-3">
              Ready to Migrate Thousands of Users?
            </h2>
            <p className="text-gray-600 mb-6 max-w-xl mx-auto">
              Let Shivaami help you achieve similar results with enterprise-scale Google Workspace migration.
            </p>
