...
const CaseStudyRJCorp = () => {
  ...
  const solutions = [
    "With Shivaami's recommendation and support, RJ Corp switched to Google Workspace Frontline Plan on January 07, 2021",
  ...
  const results = [
    ...
    "4,400 users successfully migrated",
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              RJ Corp moved to<br /><span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed max-w-3xl">
              RJ Corp is a powerhouse multinational with thriving businesses in beverages, fast-food restaurants, retail, ice cream, dairy products, healthcare, and education sectors. Founded more than two decades ago under Mr. Ravi Kant Jaipuria's creative leadership.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Old Email Service", value: "Zimbra" },
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
              ...
              <p className="text-gray-600 text-lg">Switched to Google Workspace Frontline Plan for better communication and collaboration:</p>
            </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
              ...
              <p className="text-white/80 text-lg max-w-3xl mx-auto">Made customer live on Google in just 3 days and completed the migration in 15 days for 4,400 users.</p>
            </motion.div>
