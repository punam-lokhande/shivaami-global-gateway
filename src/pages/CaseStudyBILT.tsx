...
const CaseStudyBILT = () => {
  ...
  const implementations = [
    ...
    { icon: Mail, text: "Migrating legacy email from O365 via Exchange" },
    { icon: Settings, text: "Mail Routing configuration" },
    { icon: Monitor, text: "Device Management setup" },
    { icon: Database, text: "OneDrive to Google Drive Migration" },
    { icon: Cloud, text: "Change Management and online training" }
  ];

  const objectives = [
    "Improve access to emails for staff in low network areas without VPN",
    "Reduce downtime, redundancy and occurrences of lost emails",
    "Eliminate spam and server breakdown issues",
  ...
  const challenges = [
    "Using Microsoft services, the client was fully adaptive on Microsoft applications",
    "Syncing users with Active Directory was the first requirement",
    "Vast amount of users requiring data migration made coordination a big challenge"
  ];

  const solutions = [
    "Shivaami guided BILT through a comprehensive migration process via Exchange",
    "Project management team conducted meetings on execution of the project",
    "Successfully migrated OneDrive data to Google Drive"
  ];

  const results = [
    "BILT adapted well to G Drive, Forms and Docs",
    "IT can manage domain security easily",
    "Team has more time for business continuity",
    "Expectations fulfilled with Workspace"
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              BILT moved to<br /><span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed max-w-3xl">
              Ballarpur Industries Limited (BILT) is a subsidiary of Avantha Group and India's largest manufacturer of writing and printing paper.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Old Email Service", value: "Office 365" },
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
              ...
              <p className="text-white/80 text-lg max-w-3xl mx-auto">BILT adapted well to Google Workspace, using G Drive, Forms and Docs for employee collaboration.</p>
            </motion.div>
