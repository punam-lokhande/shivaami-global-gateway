...
const CaseStudyBILT = () => {
  const highlights = [
    "Migrated 1,200+ users from Office 365 to Google Workspace",
    "OneDrive to Google Drive data migration completed",
    "Active Directory sync for user provisioning",
    "Mail routing configuration for seamless transition",
    "Device management setup across organization",
    "Change management and online training programs"
  ];

  const challenges = [
    "Fully adaptive Microsoft ecosystem requiring complete transition",
    "Active Directory sync was a primary requirement for user management",
    "Large user base made coordination a significant challenge"
  ];

  const solutions = [
    "Comprehensive migration process via Exchange with phased approach",
    "Project management team conducted regular execution meetings",
    "Successfully migrated OneDrive data to Google Drive"
  ];

  const results = [
    { label: "Users Migrated", value: "1,200+" },
    { label: "Email Support Reduction", value: "80%" },
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/bilt" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              BILT Migrated to<br />
              <span className="text-[#38B6FF]">Google Workspace from O365</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              India's largest paper manufacturer transformed their collaboration infrastructure by migrating from Office 365 to Google Workspace.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Previous Setup", value: "Office 365" },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Enterprise-grade collaboration & productivity</p>
              </div>
            </motion.div>
          </div>
        </div>
