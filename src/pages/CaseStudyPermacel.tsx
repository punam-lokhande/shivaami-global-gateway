...
const CaseStudyPermacel = () => {
  const highlights = [
    "Complete Google Workspace deployment for manufacturing operations",
    "Unified communication across production facilities",
    "Shared Drive structure for engineering documents",
    "Mobile access for plant floor supervisors",
    "Integration with ERP systems",
    "Admin console security configurations"
  ];

  const challenges = [
    "Legacy email systems with scattered data across locations",
    "Limited IT infrastructure in manufacturing plants",
    "Resistance from long-tenured employees to new technology"
  ];

  const solutions = [
    "Phased migration with minimal production disruption",
    "On-site training sessions for all employee levels",
    "Custom mobile deployment for floor supervisors"
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/permacel" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Permacel Modernized with<br />
              <span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A leading adhesive tape manufacturer unified their communication and collaboration across multiple production facilities.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-4 left-4 right-4"><p className="text-white font-medium text-sm">Unified manufacturing collaboration</p></div>
            </motion.div>
          </div>
        </div>
      </section>
...
export default CaseStudyPermacel;
