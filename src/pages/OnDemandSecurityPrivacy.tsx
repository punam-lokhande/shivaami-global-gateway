...
import heroBanner from "@/assets/banners/security-privacy-webinar.jpg";
import WatchOnDemandForm from "@/components/WatchOnDemandForm";

const OnDemandSecurityPrivacy = () => {
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/on-demand-security-privacy" />
      </Helmet>
      <Header />
        ...
        <div className="relative w-full px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 pt-24 sm:pt-28 md:pt-32 pb-8 sm:pb-12">
          ...
          >
            ...
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-[#38B6FF] drop-shadow-lg leading-tight">
              Security and Privacy with Google Workspace + Gemini
            </h2>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="overview" className="mt-6">
                  <div className="space-y-4 text-gray-700">
                    ...
                    <p>
                      Generative AI is revolutionizing the way we work—but with that transformation comes a new set of security, privacy, and compliance concerns. Organizations today face challenges such as the accidental ingestion of sensitive data, a lack of granular security controls, and risks of non-compliance with data protection regulations.
                    </p>
                    
                    <p>
                      In this webinar, you'll learn how <strong className="text-[#0C4594]">Google Workspace with Gemini</strong> delivers enterprise-grade protection while giving you complete control over your organization's data. Google ensures your data stays yours—never used to train Gemini models outside your domain without your explicit permission, and never sold or used for advertising purposes.
                    </p>

                    <p>
                      Discover how built-in features like <strong className="text-[#0C4594]">AI-driven classification, Data Loss Prevention (DLP), Information Rights Management (IRM), and client-side encryption</strong> help you safeguard sensitive information.
                    </p>
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3">
                        ...
                        <div>
                          Gemini's extensive compliance framework, including certifications like GDPR, HIPAA, FedRAMP High, ISO 27001, ISO 27701, and more
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-[#38B6FF] rounded-full mt-2 flex-shrink-0" />
                        <div>
                          The new <strong className="text-[#0C4594]">Privacy Hub for administrators</strong> with visibility into admin controls
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-[#38B6FF] rounded-full mt-2 flex-shrink-0" />
                        <div>
                          Google's transparent commitments to privacy, security, and compliance
                        </div>
                      </li>
                    </ul>
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-4 p-4 bg-gray-50 rounded-lg border-l-4 border-[#38B6FF]">
                      ...
                      <div className="text-gray-700">
                        Digital Shield for Google Workspace
                      </div>
                    </div>
                    <div className="flex gap-4 p-4 bg-gray-50 rounded-lg border-l-4 border-[#38B6FF]">
                      <div className="text-sm font-medium text-[#0C4594] whitespace-nowrap">
                      ...
                      <div className="text-gray-700">
                        From Exposed to Empowered | Demo
                      </div>
                    </div>
                    <div className="flex gap-4 p-4 bg-gray-50 rounded-lg border-l-4 border-[#38B6FF]">
                      <div className="text-sm font-medium text-[#0C4594] whitespace-nowrap">
            ...
            >
              <WatchOnDemandForm 
                ...
                moduleName="Security & Privacy with Google Workspace + Gemini"
                youtubeUrl="https://www.youtube.com/watch?v=s6XmdraQ90c"
              />
              ...
              <div className="mt-6 bg-gradient-to-r from-[#38B6FF]/10 to-[#0C4594]/10 rounded-xl p-4 border border-[#38B6FF]/30">
                ...
                <div className="space-y-2 text-sm">
                  <div className="text-[#0C4594] font-medium">✓ Module 0: Security & Privacy (You are here)</div>
...
export default OnDemandSecurityPrivacy;
