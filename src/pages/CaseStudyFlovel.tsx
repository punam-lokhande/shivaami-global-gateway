...
const CaseStudyFlovel = () => {
  const highlights = [
    "Unified platform connecting HQ with remote sites",
    "Engineering document control with version management",
    "Offline capabilities for remote mountain locations",
    "Real-time project coordination tools",
    "Compliance documentation with audit trails",
    "Mobile field access for site engineers"
  ];
  ...
  const solutions = [
    "Google Workspace deployment connecting HQ with remote project sites",
    "Structured Drive folders with version control for CAD drawings",
    "Configured offline access for teams in remote locations"
  ];

  const results = [
    { label: "Years of Legacy", value: "40+" },
    { label: "Faster Documentation", value: "50%" },
    { label: "Site Connectivity", value: "100%" },
    { label: "Project Efficiency", value: "30%" }
  ];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Flovel<br />
              <span className="text-[#38B6FF]">Connected Energy Infrastructure</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              Four decades of excellence in the hydropower industry, powering India's renewable energy future with modern collaboration tools.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 border-b border-gray-200">
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              { label: "Industry", value: "Hydropower" },
              { label: "Legacy", value: "40+ Years" },
              { label: "Projects", value: "Pan-India" },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <img 
                ...
                alt="Energy Infrastructure Platform" 
                className="w-full h-64 lg:h-80 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0C4594]/60 to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Modern collaboration for complex engineering projects</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16">
        <div className="w-full px-8 lg:px-16 xl:px-24">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-[#0C4594] mb-3">
              Ready to Power Your Infrastructure Projects?
            </h2>
            <p className="text-gray-600 mb-6 max-w-xl mx-auto">
              Let Shivaami help you connect remote sites and streamline engineering workflows.
            </p>
