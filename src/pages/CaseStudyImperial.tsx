...
const CaseStudyImperial = () => {
  const highlights = [
    "Enterprise Google Workspace for manufacturing operations",
    "Secure email infrastructure across production units",
    "Real-time collaboration for engineering teams",
    "Google Drive for technical documentation",
    "Mobile device management for shop floor access",
    "Admin controls for manufacturing data governance"
  ];

  const challenges = [
    "Multiple manufacturing units required unified platform",
    "Engineering teams needed real-time collaboration tools",
    "Technical documentation scattered across systems"
  ];

  const solutions = [
    "Deployed Google Workspace Enterprise for all units",
    "Configured shared drives with organized folder structures",
    "Implemented training for engineering and production teams"
  ];

  const results = [
    { label: "Units Connected", value: "All" },
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/imperial" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Imperial Manufacturing Upgraded to<br />
              <span className="text-[#38B6FF]">Google Workspace Enterprise</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A manufacturing company enhanced their engineering collaboration and production efficiency with enterprise-grade Google Workspace.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Solution", value: "Workspace Enterprise" },
              { label: "Focus", value: "Engineering" },
              { label: "Scale", value: "Multi-unit" }
            ].map((item, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <img 
                ...
                alt="Google Workspace Manufacturing Implementation" 
                className="w-full h-64 lg:h-80 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0C4594]/60 to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Engineering collaboration for manufacturing excellence</p>
              </div>
            </motion.div>
          </div>
        </div>
...
export default CaseStudyImperial;