...
const CaseStudyTreebo = () => {
  const highlights = [
    "Google Workspace deployment across corporate and partners",
    "Partner portal with shared drives and groups",
    "Standardized quality audit documentation templates",
    "Google Chat and Spaces for instant coordination",
    "Google Meet for remote training programs",
    "Mobile-first tools for field property management"
  ];

  const challenges = [
    "Managing communication across 700+ partner hotels in 100+ cities",
    "Real-time coordination between corporate and property managers needed",
    "Quality assurance requiring consistent communication and documentation"
  ];

  const solutions = [
    "Unified Workspace across corporate teams and hotel partners",
    "Shared drives and groups for seamless partner collaboration",
    "Standardized workflows for property audits and compliance"
  ];

  const results = [
    { label: "Hotels Connected", value: "700+" },
    { label: "Cities Covered", value: "100+" },
    { label: "Faster Onboarding", value: "60%" },
    { label: "Partner Adoption", value: "99%" }
  ];
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Treebo Hotels<br />
              <span className="text-[#38B6FF]">Smart Hospitality at Scale</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              Pioneering hospitality management with technology-driven quality assurance across 700+ hotels in India.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Properties", value: "700+ Hotels" },
              { label: "Cities", value: "100+ Cities" },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <img 
                ...
                alt="Treebo Hotels Connected Hospitality" 
                className="w-full h-64 lg:h-80 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0C4594]/60 to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Technology-driven hospitality network</p>
              </div>
            </motion.div>
          </div>
        </div>
