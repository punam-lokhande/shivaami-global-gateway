...
const CaseStudyMerinoIndia = () => {
  const highlights = [
    "1,500+ users migrated to Google Workspace",
    "Multi-location email unification",
    "Google Drive for design collaboration",
    "Real-time document sharing across plants",
    "Mobile access for field sales teams",
    "Admin console for centralized management"
  ];

  const challenges = [
    "Multiple manufacturing locations needed unified communication",
    "Design teams required collaborative file sharing solutions",
    "Legacy email systems causing productivity bottlenecks"
  ];

  const solutions = [
    "Deployed Google Workspace across all locations seamlessly",
    "Implemented shared drives for design and R&D collaboration",
    "Migrated legacy email with zero data loss"
  ];

  const results = [
    { label: "Users Migrated", value: "1,500+" },
    { label: "Locations Connected", value: "10+" },
    { label: "Email Uptime", value: "99.9%" },
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/merino-india" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Merino India Transformed with<br />
              <span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A leading manufacturer of interior solutions modernized their operations with cloud-based collaboration and communication tools.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Previous Setup", value: "Legacy Email" },
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-4 left-4 right-4"><p className="text-white font-medium text-sm">Modern collaboration for manufacturing excellence</p></div>
            </motion.div>
          </div>
        </div>
      </section>
...
export default CaseStudyMerinoIndia;
