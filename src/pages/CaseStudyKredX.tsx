...
const CaseStudyKredX = () => {
  const achievements = [
    "Increased User security, Admin control, and Device management",
    "Enabling advanced device management policy and customer controlling the corporate data, Drive and the Compliance settings",
    "Google Vault to retain the data for an indefinite period",
  ...
  const implementations = [
    { icon: Cloud, text: "Upgrading Google Workspace Account" },
    { icon: Smartphone, text: "Advanced Mobile Device Management feature operability" },
    { icon: Shield, text: "Policy implementation" },
    { icon: Archive, text: "Vault enabled to retain the data" },
    { icon: Settings, text: "Provided implementation documents for Business Plus features" },
    { icon: Database, text: "File storage and File sharing using Google Share Drive" }
  ];

  const objectives = [
    "In a single panel, improve employee access and security control to devices and data storage",
    "Increase the storage for everyone while maintaining security",
    "For their data security, management sought to do more in terms of the compliance policy"
  ];

  const challenges = [
    "The client was on the GSuite Basic and Business Plan",
    "The storage is limited for a Basic user",
    "Options/features to manage security aspects and protect User data in the trusted device were zero-to-none",
    "GSuite Basic changed to Starter and on Starter Plan lacked Google Vault, Advanced mobile device management, malware protection, and other compliance options"
  ];

  const solutions = [
    "With the recommendation and support of Shivaami Cloud Services, KredX made the switch to Google Workspace Business Plus and Business Starter on 22-October-2021",
    "Shivaami guided KredX through a comprehensive upgradation process",
    "The project management group conducted planning meetings and identified performance criteria",
    "Google Workspace Business Starter and Business Plus licenses were provisioned, and security features were implemented"
  ];

  const results = [
    "Multiple features to secure data in devices through Advanced MDM",
    "Archive user's data in the Vault conveniently",
    "IT team has more time for business continuity",
    "Ease-of-use replaced previous plan frustrations"
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              KredX India moved to<br />
              <span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed max-w-3xl">
              KredX India's leading integrated financial solutions provider, which helps startups, large enterprises, MSMEs, retailers, and distributors resolve their working capital and growth capital challenges.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Old Plan", value: "GSuite Basic & Business" },
              { label: "Employees", value: "8,500+" },
              { label: "New Solution", value: "Workspace Business Plus" }
            ].map((item, index) => (
              <motion.div
                key={index}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 text-lg">
                Switched to Google Workspace Business Starter & Plus plan for better communication, storage, and collaboration:
              </p>
            </motion.div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-white/80 text-lg max-w-3xl mx-auto">
                The admins now have multiple features to secure their data in the devices through Advanced MDM, content compliance rules, and archiving capabilities with Google Vault.
              </p>
            </motion.div>
