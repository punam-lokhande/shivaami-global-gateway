...
import { ArrowLeft, CheckCircle2, Shield, Cloud, Server, Lock, Network, AlertTriangle, Lightbulb, TrendingUp, Key, Globe } from "lucide-react";
import { Link } from "react-router-dom";

const CaseStudyAGS = () => {
  const objectives = [
    "Address security concerns in Azure infrastructure",
    "Resolve scalability issues and performance challenges",
    "Implement secure network infrastructure",
    "Fine-tune Identity and Access Management configurations",
    "Ensure alignment with organizational policies"
  ];

  const implementations = [
    { icon: Server, text: "Architected a Shared VPC environment for streamlined network administration" },
    { icon: Shield, text: "Deployed Next-Gen Firewall from Google's Marketplace for advanced threat protection" },
    { icon: Key, text: "Implemented Identity and Access Management (IAM) with fine-tuned configurations" },
    { icon: Lock, text: "Enabled encryption at rest and in transit with real-time threat detection" },
    { icon: Network, text: "Established VPN connectivity between Google Cloud and on-premises infrastructure" },
    { icon: Globe, text: "Implemented organizational policies for regulatory compliance" }
  ];

  const achievements = [
    "Advanced security features including IAM, encryption, and real-time threat detection",
    "Strengthened security through firewall rules, encryption protocols, and NGFW protections",
    "Streamlined network administration while maintaining network segmentation",
    "Guaranteed compliance with industry-specific regulations",
    "Secure connectivity between cloud and on-premises infrastructure"
  ];

  const challenges = [
    "Need for secure and well-structured network infrastructure",
    "Fine-tuning of Identity and Access Management configurations required",
    "Alignment with organizational policies was essential",
    "Required uncompromising security, scalability, and performance"
  ];

  const solutions = [
    "Enabled network segmentation between distinct projects for flexibility",
    "Ensured access to GCP resources only for authorized personnel",
    "Simplified connectivity and reduced data transfer costs",
    "Facilitated secure connectivity between cloud and on-premises infrastructure",
    "Deployed NGFW for advanced threat protection and intrusion detection"
  ];

  const results = [
    "Robust security framework with fine-tuned IAM configurations",
    "Comprehensive protection against evolving cybersecurity threats",
    "Compliant operation with industry-specific regulations",
    "Secure hybrid cloud approach with seamless integration",
    "Advanced threat protection with intrusion detection",
    "Fortified security posture of cloud environment"
  ];

  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/ags" />
      </Helmet>
      <Header />
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed max-w-3xl">
              AGS is a leading integrated omni-channel payment solutions provider in India, recognized for its dynamic and forward-thinking approach in delivering digital and cash-based solutions to banks and corporate clients.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 border-b border-gray-200">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              { label: "Industry", value: "Payment Solutions" },
              { label: "Old Infrastructure", value: "Azure" },
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 text-lg">
                AGS transformed their cloud infrastructure with Shivaami's expertise to create a secure, adaptable, and high-performing ecosystem:
              </p>
            </motion.div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-white/80 text-lg max-w-3xl mx-auto">
                AGS is now well-positioned to leverage Google Cloud's services and capabilities, ready for future growth and pioneering endeavors.
              </p>
            </motion.div>
