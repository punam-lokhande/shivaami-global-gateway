...
const OnDemandGWSWithGemini = () => {
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/on-demand-gws-with-gemini" />
      </Helmet>
      <Header />
      ...
      <section className="relative flex items-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img 
            src={heroBanner} 
            alt="Google Workspace with Gemini Webinar" 
        ...
        <div className="relative w-full px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 pt-24 sm:pt-28 md:pt-32 pb-8 sm:pb-12">
          ...
          >
            ...
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-[#38B6FF] drop-shadow-lg leading-tight">
              Unlocking Creative and Productive Potential of Workspace with Gemini
            </h2>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            >
              <div className="space-y-3 mb-6">
                <div className="flex items-center gap-3 text-[#0C4594] font-medium">
                  ...
                  <span>Wednesday, September 03, 2025</span>
                </div>
              ...
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="overview" className="mt-6">
                  <div className="space-y-4 text-gray-700">
                    ...
                    <p>
                      This introductory module introduces <strong className="text-[#0C4594]">Google Workspace with Gemini</strong>, a generative AI tool designed to enhance productivity, collaboration, and creativity. It covers how Gemini helps users write, create images, organize data, and connect more effectively.
                    </p>
                    
                    <p>
                      It showcases its AI-driven assistance in Docs, Gmail, Slides, and Sheets, along with advanced capabilities through <strong className="text-[#0C4594]">Gemini Advanced, Gems, NotebookLM Plus, and Vids.</strong>
                    </p>
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3">
                        ...
                        <div>
                          Learn how Gemini transforms your daily tasks in Google Workspace
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-[#38B6FF] rounded-full mt-2 flex-shrink-0" />
                        <div>
                          See AI-powered features in Docs, Gmail, Slides, and Sheets
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        <div className="w-2 h-2 bg-[#38B6FF] rounded-full mt-2 flex-shrink-0" />
                        <div>
                          Explore advanced tools like Gemini Advanced, Gems, and NotebookLM Plus
                        </div>
                      </li>
                    </ul>
            ...
            >
              <WatchOnDemandForm 
                ...
                moduleName="Power of Google Workspace with Gemini"
                youtubeUrl="https://www.youtube.com/watch?v=bwLgJIIJLTQ"
              />
              ...
              <div className="mt-6 bg-gradient-to-r from-[#38B6FF]/10 to-[#0C4594]/10 rounded-xl p-4 border border-[#38B6FF]/30">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="text-[#0C4594] font-medium">✓ Module 1: Power of Google Workspace (You are here)</div>
...
export default OnDemandGWSWithGemini;
