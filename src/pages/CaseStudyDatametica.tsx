...
const CaseStudyDatametica = () => {
  const achievements = [
    "Increased to unlimited storage and mobile accessibility",
  ...
  const implementations = [
    ...
    { icon: Mail, text: "Migrating legacy email from O365 to Google Workspace" },
    ...
    { icon: Cloud, text: "File storage and sharing using Google Drive" }
  ];

  const objectives = [
    "Centralize the email usage",
    "Reduce downtime, redundancy and occurrences of lost emails",
    "Eliminate the server issue",
    "Reduce IT maintenance costs with proper substitute",
    "Eliminate unnecessary expenditure on Office perpetual licenses"
  ];

  const challenges = [
    "Datametica was using O365 as email service and wanted to move for better collaboration tool",
    "Needed unlimited space and centralized IT structure in single roof"
  ];

  const solutions = [
    "Shivaami guided Datametica through a comprehensive migration process via DMS for all users",
    "Successfully converted other O365 services data to Google Workspace platform",
    "Project management team conducted meetings on execution of the project"
  ];

  const results = [
    "Increased customer interaction through Gmail",
    "Employees use Hangouts Chat and Meet regularly",
    "IT team can manage domain security easily",
    "On-premises challenges replaced with cloud"
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Datametica moved to<br /><span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed max-w-3xl">
              Datametica is a world leader in enterprise data warehouse migration to the Cloud. Their innovative frameworks automate assessment, code conversion, data migration and validation.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
              ...
              <p className="text-white/80 text-lg max-w-3xl mx-auto">An added advantage of adopting Google Workspace has been increased customer interaction and seamless collaboration.</p>
            </motion.div>
