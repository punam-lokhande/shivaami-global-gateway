...
const CaseStudyDatametica = () => {
  const highlights = [
    "Provisioning Google Workspace account for entire org",
    "Migrating legacy email from O365 to Google Workspace",
    "Mail routing configuration setup",
  ...
  const challenges = [
    "Using O365 as email service and needed better collaboration tools",
    "Needed unlimited space and centralized IT structure",
    "On-premises server issues affecting productivity"
  ];

  const solutions = [
    "Comprehensive migration via DMS for all users",
    "Successfully converted O365 services to Google Workspace",
    "Project management team guided execution throughout"
  ];

  const results = [
    { label: "Email Support Reduced", value: "80%" },
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/datametica" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Datametica<br />
              <span className="text-[#38B6FF]">O365 to Google Workspace Migration</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              World leader in enterprise data warehouse migration to the Cloud, now powered by Google Workspace for seamless collaboration.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Legacy Systems", value: "O365" },
              { label: "Employees", value: "350+" }
            ].map((item, index) => (
              <motion.div
                key={index}
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative rounded-2xl overflow-hidden shadow-xl">
              <img src={googleWorkspaceBanner} alt="Datametica Cloud Migration" className="w-full h-64 lg:h-80 object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0C4594]/60 to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Seamless O365 to Google Workspace migration</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-[#0C4594] mb-3">
              Ready to Migrate to Google Workspace?
            </h2>
            <p className="text-gray-600 mb-6 max-w-xl mx-auto">
              Let Shivaami help you achieve similar results with a seamless migration from O365 or other platforms.
            </p>
...
export default CaseStudyDatametica;