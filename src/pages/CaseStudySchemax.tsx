...
const CaseStudySchemax = () => {
  const highlights = [
    "Complete Google Workspace deployment for IT operations",
    "Secure email and communication infrastructure",
    "Cloud-based collaboration for development teams",
    "Advanced admin controls and security policies",
    "Google Drive for centralized document management",
    "Training programs for seamless adoption"
  ];

  const challenges = [
    "Growing IT team needed scalable collaboration tools",
    "Security concerns with existing email infrastructure",
    "Lack of centralized document management system"
  ];

  const solutions = [
    "Deployed Google Workspace with enterprise security features",
    "Configured advanced admin controls for IT governance",
    "Implemented structured onboarding and training programs"
  ];

  const results = [
    { label: "Team Productivity", value: "Enhanced" },
    { label: "Security Posture", value: "Improved" },
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Schemax Transformed with<br />
              <span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A leading technology and IT services company modernized their collaboration infrastructure with Google Workspace for enhanced productivity.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Focus", value: "Team Collaboration" },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Enterprise collaboration for IT excellence</p>
              </div>
            </motion.div>
          </div>
        </div>
