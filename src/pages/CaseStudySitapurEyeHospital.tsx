...
const CaseStudySitapurEyeHospital = () => {
  const highlights = [
    ...
    "Secure email for patient communication compliance",
    "Cloud-based collaboration for medical staff",
    "Google Drive for secure medical documentation",
    "Mobile access for doctors and healthcare workers",
    "Training programs for seamless clinical adoption"
  ];

  const challenges = [
    "Healthcare data security and patient privacy requirements",
    "Staff spread across multiple hospital locations",
    "Need for reliable communication during emergencies"
  ];

  const solutions = [
    "Deployed Google Workspace with healthcare-compliant security",
    "Configured data loss prevention for patient information",
    "Implemented mobile device management for clinical staff"
  ];

  const results = [
    { label: "Staff Connected", value: "100%" },
    { label: "Data Compliance", value: "HIPAA Ready" },
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Sitapur Eye Hospital Modernized with<br />
              <span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A leading eye care hospital enhanced their clinical collaboration and patient communication with secure Google Workspace deployment.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Focus", value: "Clinical Collaboration" },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Secure collaboration for healthcare excellence</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          ...
          >
            ...
            <p className="text-gray-600 mb-6 max-w-xl mx-auto">
              Let Shivaami help you achieve similar results with a tailored Google Workspace implementation for healthcare.
            </p>
