    ...
    <section ref={ref} className="relative h-[70vh] min-h-[500px] max-h-[600px] flex items-center overflow-hidden">
      ...
      <motion.div style={{ opacity }} className="relative z-10 w-full px-8 lg:px-16 xl:px-24 pt-24 lg:pt-28">
        <div className="max-w-3xl">
          ...
          >
            <Factory className="w-4 h-4 text-[#38B6FF]" />
            <span className="text-white/90 text-sm font-medium">Manufacturing</span>
          </motion.div>
          ...
          >
            <Link to="/contact">
              ...
              >
                ...
                Engage with Manufacturing IT Experts
...
function CTASection() {
  const points = [
    'Secure collaboration for manufacturing teams',
    'IP protection and access controls',
    'Device management across facilities',
    '24/7 support for manufacturing operations',
  ];
      ...
      <div className="w-full px-8 lg:px-16 xl:px-24">
        <motion.div {...fadeInUp} className="max-w-5xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Future-Proof Your Manufacturing IT
          </h2>
          <p className="text-lg text-white/80 mb-8">
            Enable efficiency, security, and scalability across your manufacturing ecosystem.
          </p>
          ...
          <Link to="/contact">
            <Button size="lg" className="bg-[#38B6FF] hover:bg-[#2da8f0] text-white font-semibold px-10 py-7 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              Engage with Shivaami's Manufacturing IT Experts
