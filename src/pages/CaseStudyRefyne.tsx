...
const CaseStudyRefyne = () => {
  const highlights = [
    "Google Workspace Enterprise with advanced security features",
    "Zero Trust security with context-aware access",
    "Remote-first collaboration infrastructure",
    "Secure B2B client communication channels",
    "DLP policies for financial data protection",
    "Google Vault for audit trails and compliance"
  ];

  const challenges = [
    "Hyper-growth requiring scalable and secure collaboration infrastructure",
    "Enterprise-grade security needed for sensitive financial data",
    "Complex B2B2C operations requiring coordination with corporate clients"
  ];

  const solutions = [
    "Enterprise Workspace with advanced security for financial compliance",
    "Context-aware access and advanced threat protection",
    "Seamless collaboration for distributed teams across Asia Pacific"
  ];

  const results = [
    { label: "Employees Empowered", value: "5M+" },
    { label: "Growth Supported", value: "10x" },
    { label: "Compliance Achieved", value: "100%" },
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Refyne<br />
              <span className="text-[#38B6FF]">Scaling Financial Wellness</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              Asia's largest Earned Wage Access platform transforming how 5M+ employees access their earned salaries.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Scale", value: "5M+ Employees" },
              { label: "Presence", value: "Asia Pacific" },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <img 
                ...
                alt="Refyne FinTech Platform" 
                className="w-full h-64 lg:h-80 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0C4594]/60 to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Secure financial technology infrastructure</p>
              </div>
            </motion.div>
          </div>
        </div>
