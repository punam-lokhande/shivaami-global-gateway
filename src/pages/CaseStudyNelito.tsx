...
const CaseStudyNelito = () => {
  const highlights = [
    "Enterprise Google Workspace deployment for IT systems company",
    "Advanced email security with DLP and compliance controls",
    "Unified collaboration platform for distributed teams",
    "Google Vault for data retention and eDiscovery",
    "Mobile device management for remote workforce",
    "Comprehensive admin training for IT governance"
  ];

  const challenges = [
    "Large distributed workforce needed unified communication",
    "Regulatory compliance requirements for data handling",
    "Legacy systems integration with modern cloud tools"
  ];

  const solutions = [
    "Deployed Google Workspace Enterprise for advanced compliance",
    "Configured Google Vault with industry-specific retention policies",
    "Implemented phased migration with minimal business disruption"
  ];

  const results = [
    { label: "Users Connected", value: "500+" },
    { label: "Compliance", value: "Achieved" },
    { label: "Collaboration", value: "Unified" },
    { label: "IT Efficiency", value: "Enhanced" }
  ];
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Nelito Systems Transformed with<br />
            ...
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A leading IT systems integrator modernized their collaboration infrastructure with enterprise-grade Google Workspace deployment.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Enterprise collaboration with compliance</p>
              </div>
            </motion.div>
          </div>
        </div>
