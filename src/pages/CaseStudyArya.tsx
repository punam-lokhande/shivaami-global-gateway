...
const CaseStudyArya = () => {
  const highlights = [
    "Cloud SQL with automated backups and PITR",
    "Shared VPC for NBFC-regulated workload isolation",
    "Cloud Armor protecting against DDoS attacks",
    "Security Command Center Premium deployment",
  ...
  const solutions = [
    "Cloud SQL deployment with automated backups and Point-In-Time Recovery",
    "Shared VPC implementation for compliance and audit readiness",
    "Security Command Center Premium for centralized risk mitigation"
  ];
  ...
  const results = [
    ...
    { label: "Faster Recovery", value: "10x" }
  ];
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Arya.ag Transformed with<br />
              <span className="text-[#38B6FF]">Google Cloud Platform</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              India's leading agritech platform modernized cloud infrastructure to serve expansive warehousing, lending, and trading operations as an RBI-regulated entity.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <img 
                src={gcpBanner} 
                alt="Google Cloud Platform Implementation" 
                className="w-full h-64 lg:h-80 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0C4594]/60 to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">RBI-compliant cloud infrastructure</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          ...
          >
            ...
            <p className="text-gray-600 mb-6 max-w-xl mx-auto">
              Let Shivaami help you achieve similar results with Google Cloud Platform.
            </p>
