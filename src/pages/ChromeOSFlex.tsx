...
function CalendarCTASection() {
  const demoPoints = [
    'Device compatibility assessment for your existing fleet',
    'Migration timeline and phased rollout approach',
    'Cost savings analysis versus new hardware purchase',
    'Chrome Enterprise management integration',
  ];
      ...
      <div className="w-full px-8 lg:px-16 xl:px-24">
        <motion.div {...fadeInUp} className="max-w-5xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Modernize existing devices with Chrome OS Flex
          </h2>
          ...
          <Link to="/lets-connect">
            <Button size="lg" className="bg-[#38B6FF] hover:bg-[#2da8f0] text-white font-semibold px-10 py-7 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              Start Your Chrome OS Flex Journey
