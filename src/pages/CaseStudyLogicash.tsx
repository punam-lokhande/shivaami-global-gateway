...
import { ArrowLeft, CheckCircle2, Cloud, Mail, Settings, Monitor, Database, AlertTriangle, Lightbulb, TrendingUp } from "lucide-react";
...
const CaseStudyLogicash = () => {
  const achievements = [
    ...
    "Stable email system with easy access in low network areas without VPN",
    "Increased cost savings due to Google Workspace features",
    "Reduced email client support by 80%",
    "Remote meetings capability enabled"
  ];

  const implementations = [
    { icon: Cloud, text: "Provisioning Google Workspace Account" },
    { icon: Mail, text: "Migrating legacy email from Netcore to Google Workspace" },
    ...
    { icon: Cloud, text: "Change Management and online training" }
  ];

  const objectives = [
    "Increase productivity by introducing cloud technology",
    "Reduce downtime, redundancy and occurrences of lost emails",
    "Eliminate spam and server breakdown issues from Netcore",
    "Reduce IT maintenance costs with proper substitute",
    "Eliminate unnecessary expenditure on Office perpetual licenses"
  ];

  const challenges = [
    "Mail communication was critical - company could not bear loss or late reply of a single mail",
    "Only 10 days of emails were available on server, rest were in email client",
    "Managing and uploading PST files from remote locations was difficult"
  ];

  const solutions = [
    "Shivaami guided Logicash through a comprehensive migration process using IMAP server",
    "Project management team conducted planning meetings and defined success criteria",
    "Changes to DNS settings, network access testing, and user data migration completed"
  ];

  const results = [
    "PST data retrieved and users live within a week",
    "Spam minimized with appropriate filters",
    "IT team has more time for business continuity",
    "On-premises challenges replaced with Workspace"
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              LogiCash moved to<br /><span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed max-w-3xl">
              LOGICASH was incorporated in 2010 with a focus on engagement with people, clients and communities. As a Cash Management solution provider for BFSI and Retail Sector, they present great vitality as an Indian player in the Cash Management Industry.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Old Email Service", value: "Netcore" },
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12">
              ...
              <p className="text-gray-600 text-lg">Switched to Google Workspace for better communication and collaboration:</p>
            </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
              ...
              <p className="text-white/80 text-lg max-w-3xl mx-auto">Within a week, PST data was retrieved and users were live, with stakeholders highly satisfied.</p>
            </motion.div>
