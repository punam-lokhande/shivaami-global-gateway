...
const CaseStudyRRGlobal = () => {
  const highlights = [
    "Google Workspace Enterprise deployment across multiple plants",
    "Unified communication for manufacturing facilities",
    "R&D collaboration hub for product innovation teams",
    "Quality documentation with structured storage",
    "Distribution network coordination tools",
    "Partner collaboration portals for dealers and vendors"
  ];
  ...
  const solutions = [
    "Google Workspace Enterprise connecting all plants and offices",
    "Secure collaboration spaces for product development teams",
    "Real-time communication tools for nationwide distribution"
  ];

  const results = [
    { label: "Corporation Value", value: "$650M+" },
    { label: "Plant Connectivity", value: "100%" },
    { label: "Faster Innovation", value: "35%" },
    { label: "IT Cost Savings", value: "50%" }
  ];
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              RR Global<br />
              <span className="text-[#38B6FF]">Connected Manufacturing Excellence</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A $650M+ electrical manufacturing corporation built on innovation, leading manufacturer of wires and cables with modern collaboration infrastructure.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 border-b border-gray-200">
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              { label: "Industry", value: "Electrical Manufacturing" },
              { label: "Revenue", value: "$650M+" },
              { label: "Facilities", value: "Multiple Plants" },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <img 
                ...
                alt="RR Global Manufacturing Excellence" 
                className="w-full h-64 lg:h-80 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0C4594]/60 to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Connected manufacturing across all facilities</p>
              </div>
            </motion.div>
          </div>
        </div>
