...
const CaseStudyMindgate = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/mindgate" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative rounded-2xl overflow-hidden shadow-xl">
              <img src={googleWorkspaceBanner} alt="FinTech Payment Infrastructure" className="w-full h-64 lg:h-80 object-cover" />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0C4594]/60 to-transparent" />
              <div className="absolute bottom-4 left-4 right-4"><p className="text-white font-medium text-sm">Enterprise payment infrastructure</p></div>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          ...
          >
            ...
            <p className="text-gray-600 mb-6 max-w-xl mx-auto">
              Let Shivaami help you achieve similar results with Google Workspace.
            </p>
