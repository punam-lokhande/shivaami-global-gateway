...
const CaseStudyApsara = () => {
  const highlights = [
    "Google Workspace unified communication platform",
    "Mobile-first tools for field sales reporting",
    "Real-time production planning documents",
    "Distribution network coordination via shared drives",
    "Centralized marketing assets management",
    "Connected Sheets for sales dashboards"
  ];

  const challenges = [
    "Legacy communication limiting coordination between plants and distribution",
    "Need for real-time inventory and sales data across operations",
    "Cold chain logistics requiring precise coordination with partners"
  ];

  const solutions = [
    "Unified platform across all locations and teams",
    "Mobile-first tools for field sales and order collection",
    "Seamless coordination with distributors via shared drives"
  ];

  const results = [
    { label: "Employees Connected", value: "1,000+" },
    { label: "Faster Reporting", value: "50%" },
    { label: "Better Coordination", value: "30%" },
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/apsara" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Apsara Ice Creams<br />
              <span className="text-[#38B6FF]">Digital-First FMCG Operations</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              Leading ice cream manufacturer embracing digital-first operations for enhanced production and pan-India distribution.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 border-b border-gray-200">
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              { label: "Industry", value: "FMCG / Dairy" },
...
export default CaseStudyApsara;