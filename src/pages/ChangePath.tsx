    ...
    <section ref={ref} className="relative min-h-[55vh] sm:min-h-[60vh] md:min-h-[65vh] lg:min-h-[70vh] max-h-[700px] flex items-center overflow-hidden">
      ...
      <motion.div style={{ opacity }} className="relative z-10 w-full px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 pt-24 sm:pt-28 md:pt-32 lg:pt-36">
        <div className="max-w-3xl">
          ...
          >
            ChangePath:<br />
            <span className="text-[#38B6FF]">Smooth</span> Technology<br />
            Transitions
          </motion.h1>
          ...
          >
            Shivaami helps your people adapt to new technology smoothly. We create training programs and communication plans that work. Our approach reduces resistance and increases adoption rates. You get measurable results and a team that embraces change.
          </motion.p>
...
function CalendarCTASection() {
  ...
  const demoPoints = [
    'Change readiness assessment — understand your organization\'s capacity for change',
    'Custom change strategy — get a tailored approach for your specific situation',
    'Training program outline — see how we\'ll prepare your team for success',
    'Adoption metrics framework — learn how we\'ll measure and improve results',
  ];
    ...
    <section className="py-20 bg-gradient-to-br from-[#0C4594] via-[#0a3a7a] to-[#082d61]">
      <div className="w-full px-8 lg:px-16 xl:px-24">
        <motion.div {...fadeInUp} className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg text-white/80 mb-8">In our discovery call, we'll discuss:</p>
