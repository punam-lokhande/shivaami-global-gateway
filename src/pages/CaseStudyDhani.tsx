...
const CaseStudyDhani = () => {
  const highlights = [
    "Enterprise Google Workspace for healthcare tech platform",
    "Secure communication infrastructure for patient data",
    "Cloud collaboration for distributed healthcare teams",
    "Advanced security controls and DLP policies",
    "Mobile device management for field staff",
    "Integration with healthcare workflows"
  ];

  const challenges = [
    "Rapid scaling requiring robust collaboration infrastructure",
    "Healthcare compliance requirements for data handling",
    "Need for secure communication across multiple locations"
  ];

  const solutions = [
    "Deployed Google Workspace Enterprise with advanced security",
    "Configured compliance-ready data retention policies",
    "Implemented secure mobile access for healthcare workers"
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/dhani" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Dhani Healthcare Powered by<br />
            ...
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A leading healthcare technology platform scaled their operations with enterprise-grade Google Workspace collaboration.
            </p>
          </motion.div>
        </div>
      </section>
