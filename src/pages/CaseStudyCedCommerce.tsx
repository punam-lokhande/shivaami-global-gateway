...
const CaseStudyCedCommerce = () => {
  const achievements = [
    ...
    "Increased cost savings due to use of Google Workspace features",
    "Reduced email client support by 80%"
  ];

  const implementations = [
    { icon: Cloud, text: "Provisioning Google Workspace Account" },
    { icon: Mail, text: "Migrate Email Data with DMS for all users" },
  ...
  const objectives = [
    "Improve access and security control to Emails and Data storage in a single panel",
    "Collaboration with all the apps",
    "Do more with compliance policy for company data security"
  ];

  const challenges = [
    "Customer was looking for a more secure and stable email solution",
    "Needed to reduce maintenance and cost from InMotion Hosting"
  ];

  const solutions = [
    "With Shivaami's recommendation and support, CedCommerce switched to Google Workspace in Sept 2019",
    "Shivaami guided through a comprehensive migration process with planning meetings and success criteria",
    "User data was migrated using GSMME post go live"
  ];

  const results = [
    "Data migration completed within 27 days",
    "Spam kept to minimum with filters",
    "IT team controls Gmail setup accounts",
    "Ease-of-use replaced old frustrations"
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              CedCommerce moved to<br /><span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed max-w-3xl">
              CedCommerce is revolutionizing the way eCommerce is perceived and performed over the Internet. Driven by a team of highly experienced professionals, they enable brick and mortar stores to make the shift to the Internet.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Old Email Service", value: "InMotion Hosting" },
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
              ...
              <p className="text-white/80 text-lg max-w-3xl mx-auto">Within 27 days, CedCommerce successfully completed data migration with highly satisfied stakeholders and employees.</p>
            </motion.div>
