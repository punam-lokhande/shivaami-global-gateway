...
const CaseStudyMicroLabs = () => {
  ...
  const implementations = [
    ...
    { icon: Mail, text: "Migrating legacy email from Lotus Notes to Google Workspace" },
  ...
  const solutions = [
    "Shivaami helped Micro Labs for migration with GSMME for IMAP migration",
    "Project management team conducted meetings on execution of the project",
    "Deployed a range of Google Cloud products and services"
  ];

  const results = [
    "Shifted from Notes to Workspace successfully",
    "Employees use Hangouts Chat and Meet regularly",
    "IT can manage domain security",
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-4xl">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Micro Labs moved to<br /><span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed max-w-3xl">
              Micro Labs Limited is a multi-faceted healthcare organization with a proficient marketing team, state-of-the-art manufacturing facilities and R&D centers at par with international standards.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Legacy Systems", value: "IBM Lotus" },
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-12">
              ...
              <p className="text-white/80 text-lg max-w-3xl mx-auto">Shifting from Lotus Notes to Google Workspace was a major achievement for the organization.</p>
            </motion.div>
