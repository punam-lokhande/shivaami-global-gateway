...
import { ArrowLeft, CheckCircle2, AlertTriangle, Lightbulb, TrendingUp, Heart, Cloud, Mail, Settings, Monitor, Database } from "lucide-react";
...
const CaseStudyMicroLabs = () => {
  const highlights = [
    "Complete Google Workspace provisioning for all users",
    "Email migration from Lotus Notes via GSMME",
    "Mail routing configuration for seamless flow",
    "Device management for secure access",
    "Document collaboration with Google Docs & Drive",
    "Change management and online training"
  ];

  const challenges = [
    "Lotus Notes was system dependent and difficult to manage",
    "High license charges that were not cost efficient",
    "Need to reduce downtime and occurrences of lost emails"
  ];

  const solutions = [
    "Complete provisioning of Google Workspace Account",
    "IMAP migration using GSMME for seamless data transfer",
  ...
  const results = [
    ...
    { label: "Users Migrated", value: "1,800" },
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/microlabs" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Micro Labs Migrated from<br />
              <span className="text-[#38B6FF]">Lotus Notes to Google Workspace</span>
            </h1>
      ...
      <section className="bg-gray-50 border-b border-gray-200">
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              { label: "Headquarters", value: "South India" },
              { label: "Industry", value: "Healthcare" },
              { label: "Legacy System", value: "IBM Lotus" },
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-4 left-4 right-4"><p className="text-white font-medium text-sm">Legacy to modern cloud collaboration</p></div>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-[#0C4594] mb-3">
              Ready to Migrate from Legacy Systems?
            </h2>
            <p className="text-gray-600 mb-6 max-w-xl mx-auto">
              Let Shivaami help you achieve similar results with Google Workspace migration.
            </p>
...
export default CaseStudyMicroLabs;
