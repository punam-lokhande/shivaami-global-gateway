...
import { ArrowLeft, CheckCircle2, Shield, Cloud, Monitor, Settings, Lock, AlertTriangle, Lightbulb, TrendingUp, Laptop, Database } from "lucide-react";
import { Link } from "react-router-dom";

const CaseStudyDunzo = () => {
  const objectives = [
    "Centralized manageability across all devices",
    "Lightweight and high performance systems",
    "Data security in case of theft or loss"
  ];

  const implementations = [
    { icon: Monitor, text: "Enrolled Chrome devices to admin panel" },
    { icon: Settings, text: "Created policies for browser management" },
    { icon: Shield, text: "Created policies to prevent data breaches through another account or removable devices" },
    { icon: Laptop, text: "Application management across all devices" },
    { icon: Lock, text: "Device Management with centralized control" },
    { icon: Database, text: "File storage and share using Google Drive" }
  ];

  const achievements = [
    "Increased user security, admin control, and device management",
    "Cost savings due to Google Workspace features",
    "Real-time data backup on the cloud"
  ];

  const challenges = [
    "Managing multiple operating systems (Windows, Linux, and MAC)",
    "Complex device configuration across the organization",
    "Need for centralized solution to reduce complexity"
  ];

  const solutions = [
    "Comprehensive migration to Chrome Enterprise with Shivaami's guidance",
    "Planning meetings defining success criteria for Chrome Enterprise",
    "Selected starting set of Chrome Enterprise features",
    "Created policies for browser and device management",
    "Implemented data breach prevention policies",
    "Change management and online training for all users"
  ];

  const results = [
    "Completed migration within 10 days",
    "Stakeholders and employees very satisfied",
    "Spam minimized with appropriate filters",
    "Hassle-free device management for IT team",
    "More time for business continuity and compliance",
    "Ease-of-use and reliability replaced earlier challenges"
  ];

  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/dunzo" />
      </Helmet>
      <Header />
        ...
        <div className="container mx-auto px-4 sm:px-6 relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Dunzo Moved to<br />
              <span className="text-[#38B6FF]">Chrome Enterprise</span>
            </h1>
            
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed max-w-3xl">
              Dunzo is an Indian company that provides delivery services across major cities including Bengaluru, Delhi, Gurugram, Pune, Chennai, Jaipur, Mumbai and Hyderabad. Headquartered in Bengaluru, India.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Industry", value: "Delivery Services" },
              { label: "Old Systems", value: "Windows, Linux, MAC" },
              { label: "Migration Time", value: "10 Days" }
            ].map((item, index) => (
              <motion.div
                key={index}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 text-lg">
                Switched to Chrome Enterprise with comprehensive migration support from Shivaami in August 2019:
              </p>
            </motion.div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-white/80 text-lg max-w-3xl mx-auto">
                Dunzo's rapid migration to Chrome Enterprise delivered significant operational improvements and user satisfaction.
              </p>
            </motion.div>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-gray-600 text-lg mb-8">
              Let Shivaami Cloud Services help you achieve similar results with Chrome Enterprise.
            </p>
