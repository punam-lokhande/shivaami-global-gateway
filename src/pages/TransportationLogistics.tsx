...
import { 
  ...
  MessageSquare, FileCheck, Database, Truck, Clock, Network, Eye, Settings
} from 'lucide-react';
  ...
  return (
    <section ref={ref} className="relative h-[70vh] min-h-[500px] max-h-[600px] flex items-center overflow-hidden">
      ...
      >
        <img
          src={logisticsImage}
          alt="Transportation & Logistics IT Solutions"
      ...
      <motion.div style={{ opacity }} className="relative z-10 w-full px-8 lg:px-16 xl:px-24 pt-24 lg:pt-28">
        <div className="max-w-3xl">
          ...
          >
            <Truck className="w-4 h-4 text-[#38B6FF]" />
            <span className="text-white/90 text-sm font-medium">Transportation & Logistics</span>
          </motion.div>
          ...
          >
            Keeping Operations Moving<br />
            <span className="text-[#38B6FF]">with Secure Digital Systems.</span>
          </motion.h1>
          ...
          >
            <Link to="/contact">
              ...
              >
                ...
                Engage with Logistics Technology Experts
...
// Connecting Fleets, Teams, and Partners Section
function TechnologySection() {
  const features = [
    {
      icon: MessageSquare,
      title: 'Secure Communication',
      desc: 'Secure communication across locations and mobile teams with encrypted channels.',
    },
    {
      icon: Settings,
      title: 'Device Management',
      desc: 'Device and identity management for field staff and drivers across the fleet.',
    },
    {
      icon: Shield,
      title: 'Data Protection',
      desc: 'Protection of shipment and customer data from cyber threats and breaches.',
    },
    {
      icon: Database,
      title: 'Backup & Recovery',
      desc: 'Backup and recovery for logistics and tracking systems ensuring continuity.',
    },
  ];
      ...
      <div className="w-full px-8 lg:px-16 xl:px-24">
        <motion.div {...fadeInUp} className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0C4594] mb-4">
            Connecting Fleets, Teams, and Partners
          </h2>
          <p className="text-[#475569] max-w-3xl mx-auto">
            Enable secure, connected logistics operations with protected data, device management, and resilient IT systems across supply chains.
          </p>
        </motion.div>
...
// Built for Operational Continuity Section
function TrustSection() {
  const benefits = [
    {
      icon: Clock,
      title: 'Reduced Downtime',
      desc: 'Reduced risk of downtime and data loss affecting deliveries.',
    },
    {
      icon: Lock,
      title: 'Secure Access',
      desc: 'Secure access across distributed operations and remote locations.',
    },
    {
      icon: Eye,
      title: 'Asset Visibility',
      desc: 'Improved visibility and control over digital assets and systems.',
    },
    {
      icon: Network,
      title: 'Resilient Systems',
      desc: 'Resilient systems for business-critical operations and tracking.',
    },
  ];
    ...
    <section className="py-20 bg-white">
      <div className="w-full px-8 lg:px-16 xl:px-24">
        <motion.div {...fadeInUp} className="text-center mb-16">
          ...
          <p className="text-[#475569] max-w-3xl mx-auto">
            Our solutions ensure logistics operations continue without interruption, keeping supply chains moving.
          </p>
        </motion.div>
...
function CTASection() {
  const points = [
    'Secure communication for logistics teams',
    'Fleet and device management solutions',
    'Data protection across supply chains',
    '24/7 support for logistics operations',
  ];
      ...
      <div className="w-full px-8 lg:px-16 xl:px-24">
        <motion.div {...fadeInUp} className="max-w-5xl mx-auto text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Drive Secure, Reliable Logistics Operations
          </h2>
          <p className="text-lg text-white/80 mb-8">
            Keep your supply chain secure and always operational.
          </p>
          ...
          <Link to="/contact">
            <Button size="lg" className="bg-[#38B6FF] hover:bg-[#2da8f0] text-white font-semibold px-10 py-7 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              Engage with Shivaami's Logistics Technology Experts
