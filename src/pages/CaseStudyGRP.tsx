...
const CaseStudyGRP = () => {
  const highlights = [
    "Google Workspace deployment for manufacturing operations",
    "Secure email infrastructure for multi-location teams",
    "Cloud collaboration for production and office staff",
    "Google Drive for centralized document management",
    "Mobile access for plant managers and field teams",
    "Admin controls for data governance"
  ];

  const challenges = [
    "Distributed manufacturing units needed unified communication",
    "Legacy email systems causing productivity issues",
    "Document management scattered across multiple systems"
  ];

  const solutions = [
    "Deployed Google Workspace with enterprise security features",
    "Configured shared drives for organized documentation",
    "Implemented mobile device management for field access"
  ];

  const results = [
    { label: "Team Connectivity", value: "Enhanced" },
    { label: "Email Efficiency", value: "Improved" },
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              GRP Ltd Modernized with<br />
              <span className="text-[#38B6FF]">Google Workspace</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A leading manufacturing company transformed their collaboration infrastructure with Google Workspace for enhanced productivity across plants.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Coverage", value: "Multi-plant" }
            ].map((item, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Enterprise collaboration for manufacturing</p>
              </div>
            </motion.div>
          </div>
        </div>
