...
import { ArrowLeft, CheckCircle2, Users, Shield, Cloud, AlertTriangle, Lightbulb, TrendingUp } from "lucide-react";
...
const CaseStudyZepto = () => {
  const highlights = [
    "2,600+ users secured with 2-Step Verification",
    "16 organizational units structured for policy management",
    "Google Vault configured with indefinite retention",
    "Drive sharing restrictions preventing data leakage",
    "Gmail DLP rules for email communications",
    "SAML SSO integrations for third-party apps"
  ];

  const challenges = [
    "Advanced security features required staged rollout and internal approvals",
    "GCPW implementation issues on Windows devices due to TPM constraints",
    "Coordination across multiple stakeholders slowed confirmations"
  ];

  const solutions = [
    "Phased POC-based approach for advanced security features",
    "Clear escalation matrix and dedicated support process",
    "Seamless transition from deployment to ongoing support"
  ];

  const results = [
    { label: "Users Secured", value: "2,600+" },
    { label: "Devices Managed", value: "250+" },
    { label: "OUs Configured", value: "16" },
    { label: "SSO Integrations", value: "Multiple" }
  ];

  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <link rel="canonical" href="https://www.shivaami.com/case-studies/zepto" />
      </Helmet>
      <Header />
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              A fast-growing quick-commerce company secured their rapidly expanding workforce with centralized collaboration and identity management.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              ...
              { label: "Previous Setup", value: "Google Workspace" },
              { label: "Employees", value: "2,600+" },
              { label: "Org Units", value: "16" }
            ].map((item, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Enterprise-grade security & collaboration</p>
              </div>
            </motion.div>
          </div>
        </div>
