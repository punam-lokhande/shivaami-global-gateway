    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="w-full px-8 lg:px-16 xl:px-24 pt-32 pb-16">
          ...
          >
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">
              Navnit Group<br />
              <span className="text-[#38B6FF]">Enterprise Conglomerate Platform</span>
            </h1>
            
            <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl">
              Rs. 2000 crore network of diverse companies spanning automotive, real estate, and retail sectors, unified under one digital platform.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="bg-gray-50 border-b border-gray-200">
        <div className="w-full px-8 lg:px-16 xl:px-24">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-200">
            {[
              { label: "Industry", value: "Conglomerate" },
              { label: "Revenue", value: "₹2000 Cr+" },
              { label: "Businesses", value: "Multi-Sector" },
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <img 
                ...
                alt="Enterprise Conglomerate Platform" 
                className="w-full h-64 lg:h-80 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0C4594]/60 to-transparent" />
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white font-medium text-sm">Unified infrastructure for diverse business verticals</p>
              </div>
            </motion.div>
          </div>
        </div>
            ...
            >
              ...
              <div className="space-y-3">
                {challenges.map((challenge, index) => (
                  <motion.div 
                    key={index} 
                    className="p-3 bg-white rounded-lg border-l-4 border-red-400 shadow-sm hover:shadow-md hover:border-red-500 transition-all cursor-default"
      ...
      <section className="py-12 sm:py-16">
        <div className="w-full px-8 lg:px-16 xl:px-24">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold text-[#0C4594] mb-3">
              Ready to Unify Your Business Group?
            </h2>
            <p className="text-gray-600 mb-6 max-w-xl mx-auto">
              Let Shivaami help you build connected infrastructure for multi-company operations.
            </p>
