...
export const API_ENDPOINTS = {
  // Subscriptions
  STORE_PRODUCTFORM_ENQUIRYDETAILS: `${API_BASE_URL}/store_productform_enquirydetails/`,
  ...
  STORE_SECURESIGHT_CUSTOMERDETAILS: `${API_BASE_URL}/store_securesight_customerdetails/`,
