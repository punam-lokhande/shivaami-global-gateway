...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className="bg-secondary border-b border-secondary/80">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-end h-10 gap-4 text-sm">
            <button className="flex items-center gap-2 text-secondary-foreground/80 hover:text-primary transition-colors">
            ...
            {/* Region Toggle */}
            <div className="flex items-center gap-1 ml-4 bg-white/10 rounded-full p-1 border border-white/20">
              <button
      ...
      {/* Main Navigation */}
      <nav className="glass border-b border-border/30 backdrop-blur-xl bg-background/95">
        <div className="container mx-auto px-4">
