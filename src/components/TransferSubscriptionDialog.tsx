  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[420px] p-0 overflow-hidden bg-white border-0 rounded-2xl">
        {/* Compact Header */}
        <div className="bg-gradient-to-r from-[#0C4594] to-[#1b9dd8] px-5 py-4">
          <DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <Input
                ...
                className={`h-10 text-sm border-slate-200 focus:border-[#1b9dd8] focus:ring-[#1b9dd8]/20 ${errors.name ? 'border-red-400' : ''}`}
              />
            ...
            <div>
              <Input
                ...
                className={`h-10 text-sm border-slate-200 focus:border-[#1b9dd8] focus:ring-[#1b9dd8]/20 ${errors.contact ? 'border-red-400' : ''}`}
              />
          ...
          <div>
            <Textarea
              ...
              rows={2}
              className={`text-sm border-slate-200 focus:border-[#1b9dd8] focus:ring-[#1b9dd8]/20 resize-none ${errors.message ? 'border-red-400' : ''}`}
            />
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1.5 bg-gradient-to-r from-[#0C4594]/5 to-[#1b9dd8]/10 px-3 py-1.5 rounded-lg border border-[#1b9dd8]/20">
            ...
            <Input
              ...
              placeholder="?"
              className={`w-16 h-9 text-sm text-center border-slate-200 focus:border-[#1b9dd8] ${errors.captcha ? 'border-red-400' : ''}`}
            />
            <Button
              type="button"
              variant="ghost"
              ...
              className="h-9 w-9 text-[#1b9dd8] hover:text-[#0C4594] hover:bg-[#1b9dd8]/10"
            >
          ...
          <motion.div whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }}>
            <Button
              ...
              className="w-full bg-gradient-to-r from-[#0C4594] to-[#1b9dd8] hover:from-[#0a3a7a] hover:to-[#1889bd] text-white font-semibold h-11 text-sm rounded-xl shadow-md transition-all duration-300"
            >
              {isSubmitting ? (
                <>
